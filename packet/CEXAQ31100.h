...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 유렉스 야간장잔고및 평가현황 ( SERVICE=CEXAQ31100,headtype=B,CREATOR=이시종,CREDATE=2012/06/26 14 )
#pragma pack( push, 1 )
...
typedef struct _CEXAQ31100OutBlock2
{
    ...
    char    TotEvalAmt          [  16];    // [long  ,   16] 총평가금액                      StartPos 81, Length 16
    char    TotPnlAmt           [  16];    // [long  ,   16] 총손익금액                      StartPos 97, Length 16
...
typedef struct _CEXAQ31100OutBlock3
{
    ...
    char    NowPrc              [  13];    // [double, 13.2] 현재가                          StartPos 114, Length 13
    char    CmpPrc              [  13];    // [double, 13.2] 대비가                          StartPos 127, Length 13
    char    EvalAmt             [  16];    // [long  ,   16] 평가금액                        StartPos 140, Length 16
    char    EvalPnl             [  16];    // [long  ,   16] 평가손익                        StartPos 156, Length 16
    char    PnlRat              [  12];    // [double, 12.6] 손익률                          StartPos 172, Length 12
    char    UnsttAmt            [  16];    // [long  ,   16] 미결제금액                      StartPos 184, Length 16
    char    BnsplAmt            [  16];    // [long  ,   16] 매매손익금액                    StartPos 200, Length 16
